            ...
            <div class="flex flex-row mx-4 mb-2 h-20">
                ...
                <div class="flex flex-wrap mx-4 mb-6">
                    <div class="w-full px-3 ">
                        ...
                        <input type="text" id="bank_id" name="bank_id" value="" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"/>
                    </div>
                </div>
